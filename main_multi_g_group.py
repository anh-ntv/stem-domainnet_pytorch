...
def main(args=args, configs=configs):
    ...
    if args.target_domain == "real":
        src_domains = ['clipart, infograph', 'quickdraw, sketch', 'painting']
    elif args.target_domain == "infograph":
        src_domains = ['clipart, real', 'quickdraw, sketch', 'painting']
    elif args.target_domain == "painting":
        src_domains = ['clipart, real, infograph', 'quickdraw, sketch']
    ...
    for epoch in range(args.start_epoch, total_epochs):
        ...
        print("TEST")
        test_trg(args.target_domain, args.source_domains, test_dloaders, generator_model_lst, dis_model, gan_model, classifier_model_lst, epoch,
        ...
        #          "backbone": generator_model_lst[0].state_dict(),
        #          "classifier": classifier_model_lst[0].state_dict(),
        #          "optimizer": optimizer_g_lst[0].state_dict(),
